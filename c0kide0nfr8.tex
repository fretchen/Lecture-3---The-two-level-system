...
\begin{align}
H = \frac{\hbar}{2}\left( \begin{array}{cc} -\Delta  &  \bra{\varphi_1}\hat{H}_0\ket{\varphi_2} \\ \bra{\varphi_2}\hat{H}_0\ket{\varphi_1} & \bra{\varphi_2}\hat{H}_0\ket{\varphi_2} \end{array} \right)
\end{align}
