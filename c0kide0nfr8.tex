...
\end{align}
If we would only prepare eigenstates the system would be rather boring. However, we typically have the ability to prepare very precisely arbitrary states with laser and microwave fields \footnote{See the discussions of n}
			\begin{align}
