...
\end{align}
This would b
If we would only prepare eigenstates the system would be rather boring. However, we typically have the ability to  precisely arbitrary states with laser and microwave fields \footnote{See the discussions of the next lecture}. Such an arbitrary state then reads in general:
\begin{align}
