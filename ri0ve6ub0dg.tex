...
i \frac{d}{dt}\left(\begin{array}{c} a_1(t) \\ a_2(t) \end{array}\right) &= \frac{1}{2}\left( \begin{array}{cc} \Delta & W_{12} \\ W_{12}^* & \tilde{E}_2 \end{array} \right) \left(\begin{array}{c} a_1(t) \\ a_2(t) \end{array} \right).
\end{align}
